        ...
        <div class="col-md-12">
            <div class="card text-center shadow">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">View Sayur</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="card" style="width: 38rem;">
                 <img src="../assets/img/terong.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <a href="pembayaran.php" class="btn btn-primary px-5" style="width: 18rem;">Beli Sekarang!</a>
                    </div>
                </div>
                </div>
                <div class="col-sm-4">
                    <div class="card-body text-start">
                        ...
                        <div class="product-stars justify-content-left" style="text-align: left; margin-top: 50px;">
